...
so far. It is the producing counterpart to the [encoder](/concepts/encoder/) —
...
[self-attention](/concepts/attention-mechanisms/)**: each position may attend
...
encoder block: a [feed-forward network](/concepts/feed-forward-networks/),
[residual connections](/concepts/residual-connections/), and
[layer normalization](/concepts/layer-normalization/), ending in an
[output head](/concepts/output-head/) that turns the final hidden state into a
...
[attention head sharing](/concepts/attention-head-sharing/) techniques attack.

## Where you'll see it

Decoder-only stacks are the backbone of essentially every modern
[large language model](/concepts/large-language-models/) — GPT, Claude, Llama.
...
[encoder–decoder models](/concepts/sequence-to-sequence-models/) (translation,
...
- [encoder](/concepts/encoder/) — the understanding counterpart
- [attention mechanisms](/concepts/attention-mechanisms/) — decoders use the causal, masked form
- [large language models](/concepts/large-language-models/) — overwhelmingly decoder-only
- [predictor](/concepts/predictor/) — contrast: a predictor outputs representations, a decoder outputs tokens

...
being largely displaced by [diffusion models](/concepts/diffusion-models/) around
2022.
...
[encoder](/concepts/encoder/) — unlike a
[variational autoencoder](/concepts/variational-autoencoders/), a vanilla GAN
...
in one forward pass, while [diffusion models](/concepts/diffusion-models/) need
...
[energy-based models](/concepts/energy-based-models/), which also assign a scalar
energy to configurations and train a network to tell real from not-real.

## Related concepts

- [diffusion models](/concepts/diffusion-models/) — the paradigm that displaced GANs; far more stable training, slower sampling
- [variational autoencoders](/concepts/variational-autoencoders/) — the other classic latent-variable generative family; likelihood-based and stable, but blurrier outputs
- [energy-based models](/concepts/energy-based-models/) — the discriminator behaves like a learned energy function (low energy = realistic)
- [convolutional neural networks](/concepts/convolutional-neural-networks/) — DCGAN established the convolutional generator/discriminator that most image GANs use
